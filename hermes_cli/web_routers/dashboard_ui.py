...
async def set_dashboard_font(body: FontSetBody):
    """Set the font override (config.yaml). Unknown ids coerce to the default
    catalog font rather than 400 so a stale client can't wedge the picker."""
    font = body.font if body.font == _FONT_THEME_ID or body.font in _FONT_CHOICES else _FONT_DEFAULT_ID

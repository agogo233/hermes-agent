...
@pytest.mark.parametrize(
    ...
    [
        ...
        # The LAN-relay sibling: the same bare-name rung, but a non-loopback endpoint so the URL
        # rung below cannot see it, plus a sibling entry that must not be matched instead.
        pytest.param(
            "model:\n  default: some-model\n  provider: my-gateway\n"
            "providers:\n  my-gateway:\n    name: My Gateway\n"
            ...
            "custom",
            id="named-providers-pin-lan-relay",
        ),
    ],
)

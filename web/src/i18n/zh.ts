...
export const zh: TranslationOverrides = {
  ...
  channels: {
    ...
    groupPolicy: "群聊策略",
    groupDisabled: "禁用（不响应群聊）",
    groupAllowlisted: "白名单",
    groupOpen: "开放（任意群）",
    qrAllowedGroupOpenIds: "允许的群 OpenID",
    qrPlaceholderGroupOpenIds: "逗号分隔的群 OpenID",
    groupOpenHelp: "开放群聊中的发送者仍需用户级授权（配对、白名单或允许所有用户）。",
    validateQqGroupPolicy: "QQ 群聊策略必须为 open、allowlist 或 disabled。",

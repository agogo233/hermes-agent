...
export const en: Translations = {
  ...
  channels: {
    ...
    groupDisabled: "Disabled (no groups)",
    groupAllowlisted: "Allowlist",
    groupOpen: "Open (any group)",
    qrAllowedGroupOpenIds: "Allowed group OpenIDs",
    qrPlaceholderGroupOpenIds: "comma-separated group OpenIDs",
    groupOpenHelp: "Senders in open groups still need user-level authorization (pairing, allowlist, or allow-all).",
    validateQqGroupPolicy: "QQ group policy must be open, allowlist, or disabled.",
